                ...
                <div className="mb-2">
                  ...
                  <div className="float-sm-right">
                    ...
                    >
                      ...
                      <ModalBody>
                        <Label>
                          <IntlMessages id="layouts.session-name" />
                        </Label>
                        <Input name="sessionName" id="session-name" value={this.state.value} onChange={this.handleSessionChange} />
                        <Label className="mt-4">
                          <IntlMessages id="layouts.session-code" />
                        </Label>
                        <Input name="sessionCode" id="session-code" value={this.state.value} onChange={this.handleSessionChange} />
                      </ModalBody>
                      <ModalFooter>
                        <Button
                          color="secondary"
                        ...
                        <Button color="primary" onClick={this.createSession}>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Card
                          onClick={event =>
                            this.handleCheckChange(event, session._id)
                          }
                        ...
                        >
                          <div className="position-relative">
                            <NavLink
                              to={`${this.props.location.pathname}/${session._id}`}
                          ...
                          <CardBody>
                            <Row>
                              ...
                              <Colxx xxs="10" className="mb-3">
                                <CardSubtitle>{session.name}</CardSubtitle>
                          ...
                          <div className="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div className="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                              ...
                              <div className="w-15 w-sm-100">
                                {/* <Badge color={session.statusColor} pill> */}
                                {/* {session.sessionCode} */}
                                {/* </Badge> */}
                              </div>
                            </div>
