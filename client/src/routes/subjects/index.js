...
class DataListLayout extends Component {
  ...
  deleteSubject = () => {
    axios.delete(this.state.apiUrl + "/" + this.state.subject)
      .then((response) => {
        ...
        <Fragment>
          <div className="disable-text-selection">
            ...
            <Modal isOpen={this.state.modal} toggle={this.toggle}>
              ...
              <ModalFooter>
                <Button color="danger" onClick={this.deleteSubject}>
                  Delete
                </Button>{" "}
                    ...
                    >
                      <div className="pl-2 d-flex flex-grow-1 min-width-zero">
                        <div className="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                          ...
                          <div className="w-sm-100">
                            <NavLink
                              to={`${this.props.location.pathname}/${subject._id}/edit`}
                              className="w-30 w-sm-100"
                            >
                          ...
                          <div className="w-sm-100">
                            <Button color="danger"
                              onClick={() => { this.toggle(); this.subjectselected(subject._id) }}
                            >
                              Delete
                            </Button>
                          </div>
