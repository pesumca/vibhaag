        ...
        <div className="disable-text-selection">
          <Row>
            <Colxx xxs="12">
              <div className="mb-2">
                <h1>
                  Listing all semesters of department of {this.state.department.name}
                </h1>
                ...
                <div className="float-sm-right">
                  ...
                  >
                    ...
                    <ModalBody>
                      <Label>
                        <IntlMessages id="layouts.semester-name" />
                      </Label>
                      <Input name="departmentName" id="semester-name" value={this.state.value} onChange={this.handleDepartmentChange} />
                      <Label className="mt-4">
                        <IntlMessages id="layouts.semester-code" />
                      </Label>
                      <Input name="departmentCode" id="semester-code" value={this.state.value} onChange={this.handleDepartmentChange} />
                    </ModalBody>
                    <ModalFooter>
                      <Button
                        color="secondary"
          ...
          <Row>
            {this.state.department.semesters.map(semester => {
              if (this.state.displayMode === "imagelist") {
                return (
                  ...
                  >
                    ...
                    >
                      <Card
                        onClick={event =>
                          this.handleCheckChange(event, semester._id)
                        }
                      ...
                      >
                        <div className="position-relative">
                          <NavLink
                            to={`${this.props.location.pathname}/${semester._id}`}
                        ...
                        <CardBody>
                          <Row>
                            ...
                            <Colxx xxs="10" className="mb-3">
                              <CardSubtitle>{semester.number}</CardSubtitle>
                ...
                return (
                  <Colxx xxs="12" key={semester._id} className="mb-3">
                    <ContextMenuTrigger
                      id="menu_id"
                      data={semester._id}
                      collect={collect}
                      ...
                      >
                        <div className="pl-2 d-flex flex-grow-1 min-width-zero">
                          <div className="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                            ...
                            <div className="w-15 w-sm-100">
                              {/* <Badge color={semester.statusColor} pill>
                                  {semester.departmentCode}
                                </Badge> */}
                            </div>
                          </div>
                          <div className="custom-control custom-checkbox pl-1 align-self-center pr-4">
