        ...
        <div className="disable-text-selection">
          <Row>
            <Colxx xxs="12">
              <div className="mb-2">
                <h1>
                  Listing all subjects of department of {this.state.department.name}
                </h1>
                ...
                <div className="float-sm-right">
                  ...
                  >
                    ...
                    <ModalBody>
                      ...
                      <Input name="departmentName" id="subject-name" value={this.state.value} onChange={this.handleDepartmentChange} />
                      <Label className="mt-4">
                        <IntlMessages id="layouts.subject-code" />
                      </Label>
                      <Input name="departmentCode" id="subject-code" value={this.state.value} onChange={this.handleDepartmentChange} />
                    </ModalBody>
                    <ModalFooter>
                      <Button
                        color="secondary"
          ...
          <Row>
            {this.state.department.subjects.map(subject => {
                        ...
                        <CardBody>
                          <Row>
                            ...
                            <Colxx xxs="10" className="mb-3">
                              <CardSubtitle>{subject.number}</CardSubtitle>
