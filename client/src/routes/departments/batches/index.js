...
class FormsUi extends Component {
	constructor(props) {
		...
		this.state = {
			apiUrl: "http://localhost:3000/" + "batches",
			batch: [],
		};
	}
					...
					<Colxx xxs="12">
						<Card>
							<CardBody>
								...
								<CardSubtitle>Create New Batch</CardSubtitle>
                        ...
                        Number of Students
											...
											<AvInput
												name="batchCode"
												id={this.state.batch.batchCode + this.state.batch._id}
												value=""
												onChange={this.handleBatchChange}
												required
											/>
									...
									<Colxx sm={6}>
										<AvGroup>
											...
											<AvInput
												name="description"
												id={this.state.batch.description + this.state.batch._id}
												value=""
												onChange={this.handleBatchChange}
												required
											/>
